...
## Error Codes
| num  | code description                     | more detail              | RU detail                                                      | Full description |
| ---- | -------------------------------------| ------------------------ |----------------------------------------------------------------| ---------------------- |
| 10## | **Phone errors**                     |                          | **Ошибки номера телефона**                                     | Введите номер телефона |
| 1001 | empty phone                          |                          | Введите номер телефона                                         | Введите корректный номер телефона |
